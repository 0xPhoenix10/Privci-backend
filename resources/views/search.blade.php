...
<div class="container-fluid main-container pt-7 pb-7 bg-darker">
    ...
    <div class="text-center mt-5">
        <h2 class="text-white">Search result(s) for: <span class="search-value">fonns.kenedy211@privci.com</span></h2>
    </div>
        ...
        <div class="col-xl-12 mb-4">
            <div class="card-header rounded bg-dark">
                ...
                <div class="d-flex">
                    ...
                    <p class="m-0 text-white">In April 2016, client information got from the spilling application known
                        as
                        "17" seemed recorded available to be purchased on a Tor concealed assistance commercial center.
                        The
                ...
                <div class="d-flex">
                    ...
                    <p class="col-9 m-0 text-white">The AntiPublic Combo List is a massive database of email addresses
                        and
