    ...
    <div class="text-center text-white">
        ...
        <div class="container d-flex bg-white rounded search-form">
            ...
            <div class="d-flex align-items-center text-center">
                <button class="btn p-0 border-0" id="search-btn">
                    <h4 class="p-1 border border-primary rounded text-dark">Search</h4>
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-12 mb-4">
        <div class="card-header rounded bg-dark">
            ...
            <div class="d-flex">
                ...
                <p class="m-0 text-white">In April 2016, client information got from the spilling application known as
                    "17" seemed recorded available to be purchased on a Tor concealed assistance commercial center. The
                    information contained more than 4 million remarkable email addresses alongside IP addresses,
                    usernames and passwords put away as unsalted MD5 hashes.</p>
            </div>
            <div class="d-flex">
            ...
            <div class="d-flex">
                ...
                <p class="col-9 m-0 text-white">The AntiPublic Combo List is a massive database of email addresses and
                    passwords created by aggregating data from different data breaches.</p>
            </div>
        </div>
    </div>
    <div class="col-xl-12 mb-4">
